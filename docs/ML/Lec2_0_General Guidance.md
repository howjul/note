...
![image-20210311203322900](lihongyi_pic/image-20210311203322900.png)
...
![image-20210311203956745](lihongyi_pic/image-20210311203956745.png)

​	训练集就要拿来训练我们的Model，训练Model的过程上周已经讲过了，训练的过程就是**三个步骤**
...
![image-20210311205104719](lihongyi_pic/image-20210311205104719.png)
...
![image-20210311205956634](lihongyi_pic/image-20210311205956634.png)
...
![image-20210311212242288](lihongyi_pic/image-20210311212242288.png)
...
​	但是并不是training的时候，loss大就代表一定是model bias，你可能会遇到另外一个问题，这个问题是什么，这个问题是**optimization做得不好**，什么意思呢？
...
![image-20210311214054168](lihongyi_pic/image-20210311214054168.png)
...
![image-20210313203557412](lihongyi_pic/image-20210313203557412.png)
...
![image-20210313203829786](lihongyi_pic/image-20210313203829786.png)
...
![image-20210313204055684](lihongyi_pic/image-20210313204055684.png)
...
​	为什么会有overfitting这样的状况呢，为什么有可能training的loss小，testing的loss大呢，这边就举一个极端的例子。 	![image-20210313204504732](lihongyi_pic/image-20210313204504732.png)
...
![image-20210313205555809](lihongyi_pic/image-20210313205555809.png)
...
![image-20210313205653097](lihongyi_pic/image-20210313205653097.png)
...
![image-20210313205918762](lihongyi_pic/image-20210313205918762.png)
...
![image-20210313210215733](lihongyi_pic/image-20210313210215733.png)
...
![image-20210313210406236](lihongyi_pic/image-20210313210406236.png)
...
![image-20210313210826241](lihongyi_pic/image-20210313210826241.png)
...
![image-20210313211712938](lihongyi_pic/image-20210313211712938.png)
...
![image-20210313212322570](lihongyi_pic/image-20210313212322570.png)
...
![image-20210313212632577](lihongyi_pic/image-20210313212632577.png)
...
![image-20210313213154441](lihongyi_pic/image-20210313213154441.png)
...
![image-20210313213301109](lihongyi_pic/image-20210313213301109.png)
...
![image-20210313213904472](lihongyi_pic/image-20210313213904472.png)
...
![image-20210313215102410](lihongyi_pic/image-20210313215102410.png)
...
![image-20210313215406332](lihongyi_pic/image-20210313215406332.png)
...
![image-20210313215636180](lihongyi_pic/image-20210313215636180.png)
...
![image-20210313220115627](lihongyi_pic/image-20210313220115627.png)

那这个就是我们要做的结果，上周比较多人选了三层的network，所以我们就把三层的network，拿来测试一下，以下是测试的结果，我们就没有再调参数了，大家决定用三层的就是下好离手了，就直接用上去了

![image-20210313220138585](lihongyi_pic/image-20210313220138585.png)
...
![image-20210313220235078](lihongyi_pic/image-20210313220235078.png)

​	那也有人会说，mismatch也算是一种Overfitting，这样也可以，这都只是名词定义的问题，那我这边想要表达的事情是，**mismatch它的原因跟overfitting，其实不一样**，一般的overfitting，你可以用搜集更多的资料来克服，但是**mismatch意思是说，你今天的训练集跟测试集，它们的分布是不一样的**

![image-20210313220434830](lihongyi_pic/image-20210313220434830.png)
...
![image-20210313220457880](lihongyi_pic/image-20210313220457880.png)
