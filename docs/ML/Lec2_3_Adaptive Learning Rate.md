...
现在我们要有一个**随着参数客制化的learning rate**，我们把原来learning rate $η$这一项呢，改写成$\frac{η}{σᵢᵗ}$
...
以在RMS Prop里面，我们这个σᵢ¹它是前一步算出来的σᵢ⁰，里面就是有gᵢ⁰，所以这个**σᵢ⁰就代表了gᵢ⁰的大小**，所以它是(σᵢ⁰)²，乘上α加上(1-α)，乘上现在我们刚算出来的，新鲜热腾腾的gradient就是gᵢ¹
